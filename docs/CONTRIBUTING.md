...
To navigate our codebase with confidence, fork and install the project to familiarize yourself with the code :confetti_ball:.

Check to see what type of contribution you are comfortable with before making changes. Some of them don't even require writing a single line of code :sparkles:.
...
2. Install or update using `npm i` or `npm install` commands.
...
- We may ask for changes to be made before a PR can be merged, either using [suggested changes](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/incorporating-feedback-in-your-pull-request) or pull request comments. You can make the changes in your fork, then commit them to your branch.
